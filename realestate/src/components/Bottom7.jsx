...
const Bottom7 = () => {
    ...
    return (
        <div className="p-1">
            {s6.map((num) => (
                <div key={num} className="bg-[#9c4e1a] md:w-10 w-7 h-10 md:border-1 border-1 border-black flex justify-center items-center cursor-pointer" onClick={() => handleNumberClick(num)}>
