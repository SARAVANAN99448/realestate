  ...
  return (
    <div className="relative w-full min-h-screen flex items-center justify-center mb-10 md:mt-20 mt-10">
      ...
      <div className="text-center text-white relative md:px-20 px-10 text-[17px]">
        ...
        <div className="border-4 cursor-pointer border-white rounded-xl px-6 py-4 bg-black/50 text-white text-center w-full mt-4 transition-all duration-300 hover:bg-green-700/70 hover:-translate-y-2">
          ...
          <p>A getaway that rejuvenates the soul, Chikkamagaluru offers a perfect blend of nature, culture, and adventure for every traveler.</p>
        </div>
      </div>
    </div>
  );
