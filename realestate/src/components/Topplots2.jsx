...
const row1 = [
    { number: 142, className: "bg-pink-300 w-[11.7%] h-10 border-3 border-black flex justify-center items-center cursor-pointer" },
    { number: 143, className: "bg-pink-300 w-[11.7%] h-10 border-3 border-black flex justify-center items-center cursor-pointer" },
    { number: 144, className: "bg-pink-300 w-[11.7%] h-10 border-3 border-black flex justify-center items-center cursor-pointer" },
    { number: 145, className: "bg-pink-300 w-[11.7%] h-10 border-3 border-black flex justify-center items-center cursor-pointer" },
    { number: 146, className: "bg-pink-300 w-[11.7%] h-10 border-3 border-black flex justify-center items-center cursor-pointer" },
    { number: 147, className: "bg-[#9c4e1a] w-28 h-10 border-3 border-black flex justify-center items-center topplots2 cursor-pointer" },
  ];
